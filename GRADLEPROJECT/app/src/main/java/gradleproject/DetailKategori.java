...
public class DetailKategori {
    ...
    public DetailKategori(String namaKategori) {
        view = new VBox(25);
        ...
        // =====================================================================
        // 2. SEKSYEN BINGKAI UTAMA (KAPSUL TAB MENEMPEL SESUAI MOCKUP)
        // =====================================================================
        VBox sectionDetail = new VBox(0); // Spacing 0 agar tab pas menempel di atas boks biru
        sectionDetail.setMaxWidth(800);
        VBox.setVgrow(sectionDetail, Priority.ALWAYS);

        // Kapsul Tab Di Atas Box
        HBox tabKategori = new HBox();
        Label lblTabKategori = new Label(namaKategori);
        lblTabKategori.setStyle(
            "-fx-background-color: #FF9800; " + // Warna Oranye Menyala
            "-fx-text-fill: white; " +
            "-fx-font-family: 'Poppins'; " +
            "-fx-font-weight: bold; " +
            "-fx-font-size: 13px; " +
            "-fx-background-radius: 10 10 0 0; " + // Melengkung hanya di sudut atas
            "-fx-padding: 6 22;"
        );
        tabKategori.getChildren().add(lblTabKategori);
        ...
        // D. Grid Metadata Parameter Informasi
        ...
        btnKembali.setOnAction(event -> {
            if (DashboardUser.getInstance() != null) {
                DashboardUser.getInstance().pindahKeKategoriUser();
            }
        });
        ...
        // 👉 KUNCI SCROLL: Menggulung kartu putih bagian dalam wadah biru secara mandiri
        ...
        sectionDetail.getChildren().addAll(tabKategori, boxBlueContainer);
