...
public class DetailAcaraMusik {
    ...
    public DetailAcaraMusik() {
        ...
        try {
            ...
            Image img = new Image(getClass().getResourceAsStream("/aset/gambarLuminara/img-musik-detail.png"));
            imgEvent.setImage(img);
        } catch (Exception e) {
            System.out.println("⚠️ Gambar acara musik tidak ditemukan.");
        }
        ...
        Label lblTitle = new Label("Makassar Traditional Costume Showcase"); // Teks disesuaikan dari mockup
